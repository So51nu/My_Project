...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO donations_food (food_name, meal_type, category, quantity, quantity_type, name, phone, area, address, ngo)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssissssss", $food_name, $meal_type, $category, $quantity, $quantity_type, $name, $phone, $area, $address, $ngo);

    if ($stmt->execute()) {
        echo "<script>showNotification('Donation submitted successfully!', 'success');</script>";
    } else {
        echo "<script>showNotification('Error: " . $stmt->error . "', 'error');</script>";
    }
...
<body>
        ...
        <div class="container">
            ...
            <div class="campaign-grid">
                ...
                <div class="campaign-item slide-in-right">
                   ...
                   <div class="campaign-item slide-in-left">
                    <img src="img/5.webp" alt="Campaign 1" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Feed 100 Families</h3>
                        <p class="campaign-description">Help us provide nutritious meals to 100 underprivileged families for a month.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
                ...
                <div class="campaign-item slide-in-left">
                    <img src="img/6.webp" alt="Campaign 2" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">School Lunch Program</h3>
                        <p class="campaign-description">Ensure every child in our local schools gets a healthy lunch every day.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
                ...
                <div class="campaign-item slide-in-right">
                    <img src="img/7.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
               ...
               <div class="campaign-item slide-in-left">
                    <img src="img/8.webp" alt="Campaign 1" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Feed 100 Families</h3>
                        <p class="campaign-description">Help us provide nutritious meals to 100 underprivileged families for a month.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
                ...
                <div class="campaign-item slide-in-left">
                    <img src="img/9.webp" alt="Campaign 2" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">School Lunch Program</h3>
                        <p class="campaign-description">Ensure every child in our local schools gets a healthy lunch every day.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
                ...
                <div class="campaign-item slide-in-right">
                    <img src="img/10.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
  ...
  <div class="campaign-item slide-in-left">
                    <img src="img/11.webp" alt="Campaign 1" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Feed 100 Families</h3>
                        <p class="campaign-description">Help us provide nutritious meals to 100 underprivileged families for a month.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
                ...
                <div class="campaign-item slide-in-left">
                    <img src="img/12.webp" alt="Campaign 2" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">School Lunch Program</h3>
                        <p class="campaign-description">Ensure every child in our local schools gets a healthy lunch every day.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
                ...
                <div class="campaign-item slide-in-right">
                    <img src="img/14.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
...
<div class="campaign-item slide-in-right">
                    <img src="img/13.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
...
<div class="campaign-item slide-in-right">
                    <img src="img/15.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
...
<div class="campaign-item slide-in-right">
                    <img src="img/16.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
...
<div class="campaign-item slide-in-right">
                    <img src="img/17.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
...
<div class="campaign-item slide-in-right">
                    <img src="img/18.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
...
<div class="campaign-item slide-in-right">
                    <img src="img/19.webp" alt="Campaign 3" class="campaign-image">
                    <div class="campaign-content">
                        <h3 class="campaign-title">Meals for Seniors</h3>
                        <p class="campaign-description">Provide nutritious meals and companionship to elderly individuals in our community.</p>
                        <a href="#" class="btn scale-in">Support Now</a>
...
<div class="story-item slide-in-right">
                    <img src="img/23.webp" alt="Story 3" class="story-image">
                    <div class="story-content">
                        <h3 class="story-title">Sarah, Volunteer</h3>
                        <p class="story-text">"Volunteering with FoodShare has opened my eyes to the power of community. It's incredible to see how we can make a difference together."</p>
                    </div>
...
<div class="story-item slide-in-right">
                    <img src="img/25.webp" alt="Story 3" class="story-image">
                    <div class="story-content">
                        <h3 class="story-title">Sarah, Volunteer</h3>
                        <p class="story-text">"Volunteering with FoodShare has opened my eyes to the power of community. It's incredible to see how we can make a difference together."</p>
                    </div>
...
<div class="story-item slide-in-right">
                    <img src="img/24.webp" alt="Story 3" class="story-image">
                    <div class="story-content">
                        <h3 class="story-title">Sarah, Volunteer</h3>
                        <p class="story-text">"Volunteering with FoodShare has opened my eyes to the power of community. It's incredible to see how we can make a difference together."</p>
                    </div>
...
<div class="story-item slide-in-right">
                    <img src="img/26.webp" alt="Story 3" class="story-image">
                    <div class="story-content">
                        <h3 class="story-title">Sarah, Volunteer</h3>
                        <p class="story-text">"Volunteering with FoodShare has opened my eyes to the power of community. It's incredible to see how we can make a difference together."</p>
                    </div>
...
<div class="story-item slide-in-right">
                    <img src="img/28.webp" alt="Story 3" class="story-image">
                    <div class="story-content">
                        <h3 class="story-title">Sarah, Volunteer</h3>
                        <p class="story-text">"Volunteering with FoodShare has opened my eyes to the power of community. It's incredible to see how we can make a difference together."</p>
                    </div>
...
<div class="story-item slide-in-right">
                    <img src="img/27.webp" alt="Story 3" class="story-image">
                    <div class="story-content">
                        <h3 class="story-title">Sarah, Volunteer</h3>
                        <p class="story-text">"Volunteering with FoodShare has opened my eyes to the power of community. It's incredible to see how we can make a difference together."</p>
                    </div>
    ...
    <section id="donate" class="section">
        <div class="container">
            <h2 class="section-title fade-in" style="color: #2C3E50;">Donate Food</h2>
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="donationForm" class="fade-in">
                <div class="form-group">
                    <label for="food_name" style="color: #34495E;">Food Name:</label>
                    <input type="text" id="food_name" name="food_name" required>
                </div>

                <div class="form-group">
                    <label style="color: #34495E;">Meal Type:</label>
                    <div class="radio-group">
                        <label style="color: #2980B9;"><input type="radio" name="meal_type" value="Veg" required> Veg</label>
                        <label style="color: #2980B9;"><input type="radio" name="meal_type" value="Non-Veg"> Non-Veg</label>
                    </div>
                </div>

                <div class="form-group">
                    <label style="color: #34495E;">Category:</label>
                    <div class="checkbox-group">
                        <label style="color: #2980B9;"><input type="checkbox" name="category[]" value="Raw Food"> Raw Food</label>
                        <label style="color: #2980B9;"><input type="checkbox" name="category[]" value="Cooked Food"> Cooked Food</label>
                        <label style="color: #2980B9;"><input type="checkbox" name="category[]" value="Packed Food"> Packed Food</label>
                    </div>
                </div>

                <div class="form-group">
                    <label for="quantity" style="color: #34495E;">Quantity:</label>
                    <input type="number" id="quantity" name="quantity" required>
                    <select id="quantity_type" name="quantity_type" style="color: #2980B9;">
                ...
                <div class="form-group">
                    <label for="name" style="color: #34495E;">Your Name:</label>
                    <input type="text" id="name" name="name" required>
                </div>

                <div class="form-group">
                    <label for="phone" style="color: #34495E;">Phone Number:</label>
                    <input type="tel" id="phone" name="phone" required>
                </div>

                <div class="form-group">
                    <label for="area" style="color: #34495E;">Area:</label>
                    <select id="area" name="area" required style="color: #2980B9;">
                ...
                <div class="form-group">
                    <label for="address" style="color: #34495E;">Delivery Address:</label>
                ...
                <button type="submit" class="btn scale-in" style="background-color: #E74C3C; color: #FFFFFF;">Submit Donation</button>
            </form>
        </div>
    </section>
    ...
    <script>
        ...
        function validateForm() {
            ...
            categoryCheckboxes.forEach(checkbox => {
                if (checkbox.checked) categoryChecked = true;
            });
            if (!categoryChecked) {
                isValid = false;
